...
public class OpenidConfigurer extends WebMvcConfigurerAdapter {
  ...
  public void addInterceptors(InterceptorRegistry registry) {
    ...
    registry.addInterceptor(getOpenidInterceptor()).addPathPatterns("/api/**").excludePathPatterns("/api/user/login/**").excludePathPatterns("/api/roomshedule/**").excludePathPatterns("/api/dialog/**").excludePathPatterns("/api/countdown/**");
