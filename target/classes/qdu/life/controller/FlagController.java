...
public class FlagController {
  ...
  Result insertPrivateFlag(HttpServletRequest request,@RequestBody FlagModel flagModel){
    String openid = (String)request.getAttribute("openid");
    flagModel.setOpenid(openid);
    flagModel.setCreate_date(new Date());

    return ResultUtils.ok(service.insertNewFlag(openid,flagModel));
  }
